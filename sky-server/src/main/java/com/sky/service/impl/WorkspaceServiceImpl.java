...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    public BusinessDataVO getBusinessData(LocalDateTime begin, LocalDateTime end) {
        ...
        //查询总订单数
        Integer totalOrderCount = orderMapper.countAllOrders(begin,end).intValue();
        ...
        //有效订单数
        Integer validOrderCount = orderMapper.countOrdersByStatus(Orders.COMPLETED,begin,end).intValue();
        ...
        //新增用户数
        Integer newUsers = userMapper.countNewUserByMap(map).intValue();
